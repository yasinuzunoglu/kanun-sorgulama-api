...
# -*- coding: utf-8 -*-
"""
Vercel için Kanun Sorgulama API
Bu dosya Vercel serverless functions için optimize edilmiştir.
"""
...
def init_app():
    ...
    if not kanun_data:
        print("Kanunlar yükleniyor...")
        gist_urls = load_all_gist_urls()
        
        if gist_urls:
            # İlk 50 kanunu yükle (Vercel limitleri için)
